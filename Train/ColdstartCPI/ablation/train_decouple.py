...
import random
from model import WODecouple
from dataset import load_WODecouple1
...
if __name__ == "__main__":
    ...
    for i_fold in range(K_Fold):
        ...
        train_dataset_load, valid_dataset_load, test_dataset_load = load_WODecouple1(DATASET, batch_size=Batch_size,i_fold=i_fold,setting=scenarios)

        """ create model"""
        model = WODecouple(unify_num=1024,head_num=4)
