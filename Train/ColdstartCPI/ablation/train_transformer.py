...
if __name__ == "__main__":
    ...
    save_path = "./Results/WOTransformer/{}/{}/".format(DATASET,Setting)
    ...
    for i_fold in range(K_Fold):
        ...
        train_dataset_load, valid_dataset_load, test_dataset_load = load_WOTransformer1(DATASET, batch_size=Batch_size,i_fold=i_fold,setting=Setting)
