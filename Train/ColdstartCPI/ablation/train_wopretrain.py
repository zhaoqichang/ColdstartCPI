...
import random
from model import WOPretrain
from dataset import load_WOPretrain1
...
if __name__ == "__main__":
    ...
    save_path = "./Results/Pretrain/{}/{}/".format(DATASET,scenarios)
    ...
    for i_fold in range(K_Fold):
        ...
        train_dataset_load, valid_dataset_load, test_dataset_load = load_WOPretrain1(DATASET, batch_size=Batch_size,i_fold=i_fold,setting=scenarios)

        """ create model"""
        model = WOPretrain(unify_num=512,head_num=4)
